...
export default function Hero() {
    ...
    return (
        <section id="home" className="h-screen flex items-center px-4 sm:px-6 lg:px-8 relative bg-cover bg-center bg-no-repeat border-b-4 border-white" style={{ backgroundImage: 'url(/team.jpg)' }}>
