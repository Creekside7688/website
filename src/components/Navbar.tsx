                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-center space-x-3">
                            ...
                            <div className="flex -space-x-1">
                                <a href="https://www.instagram.com/byrnerobotics" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white hover:bg-white/10 px-2 py-2 rounded transition-colors duration-200">
                                ...
                                <a href="mailto:byrnecreekfirstrobotics@gmail.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white hover:bg-white/10 px-2 py-2 rounded transition-colors duration-200">
                                    <span className="sr-only">Email</span>
                                    <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                    </svg>
                                </a>
                                <a href="https://github.com/creekside7688" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white hover:bg-white/10 px-2 py-2 rounded transition-colors duration-200">
