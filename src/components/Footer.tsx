                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/byrnerobotics" className="text-gray-400 hover:text-blue-400 transition-colors">
                            ...
                            <a href="mailto:byrnecreekfirstrobotics@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors">
                                <span className="sr-only">Email</span>
                                <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                </svg>
                            </a>
                            <a href="https://github.com/creekside7688" className="text-gray-400 hover:text-blue-400 transition-colors">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <a href="mailto:byrnecreekfirstrobotics@gmail.com" className="flex items-center gap-3 text-gray-400 hover:text-blue-400 transition-colors">
                                <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                </svg>
                                <span>byrnecreekfirstrobotics@gmail.com</span>
                            </a>
                            <a href="https://www.instagram.com/byrnerobotics" className="flex items-center gap-3 text-gray-400 hover:text-blue-400 transition-colors">
